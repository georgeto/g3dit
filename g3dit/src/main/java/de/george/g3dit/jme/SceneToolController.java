...
/**
 * This class can be used or extended by other plugins to display standard tools in the tools scene
 * e.g. a cursor etc.
 *
 * @author normenhansen
 */
public abstract class SceneToolController implements AppState {
	protected NodeViewerApp app;
	...
	public SceneToolController(NodeViewerApp app, AssetManager manager) {
		this(app, new Node("ToolsNode"), manager);
	}

	@SuppressWarnings("LeakingThisInConstructor")
	public SceneToolController(NodeViewerApp app, Node toolsNode, AssetManager manager) {
		this.app = app;
