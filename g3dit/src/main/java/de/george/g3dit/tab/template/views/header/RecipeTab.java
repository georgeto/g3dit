...
public class RecipeTab extends AbstractTemplateTab {
	...
	public void initComponents() {
		...
		add(SwingUtils.createBoldLabel(I.tr("Category")), "spanx, wrap");
		...
		add(SwingUtils.createBoldLabel(I.tr("Ingredients")), "gaptop 10, spanx, wrap");
		...
		add(SwingUtils.createBoldLabel(I.tr("Result")), "gaptop 10, spanx, wrap");
		add(new JLabel("Item"), "gapleft 7, spanx 2");
		add(new JLabel("Amount"), "wrap");
		...
		add(SwingUtils.createBoldLabel(I.tr("Requirements")), "gaptop 10, spanx, wrap");
