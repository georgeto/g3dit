...
public class FileDialogWrapper {
	public static final ExtensionsFilter NO_FILTER = createFilter("Alle", "*");
	...
	public static final ExtensionsFilter ARCHIVE_FILTER = createFilter("Weltdaten", "lrentdat", "node");
